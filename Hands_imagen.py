...
#Ayuda a dibujar los 21 puntos de la mano y sus conexiones
...
with mp_hands.Hands(
    ...
    if results.multi_hand_landmarks is not None:
        ...
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Coordenada en x,y de los demas dedos
    ...
    if results.multi_hand_landmarks is not None:
        # ------------------------------
        # Accediendo a los puntos clave, de acuerdo al indice
        index = [4, 8, 12, 16, 20]
        for hand_landmarks in results.multi_hand_landmarks:
